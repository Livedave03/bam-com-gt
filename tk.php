...
<body class="body">
    ...
    <div class="popup" id="popup">
        <p>Método de verificación inválido: Confirma tu identidad con tu token BAMAPP. Ingresa el código token que se muestra en el inicio de tu BAMAPP para continuar.</p>
